...
## We are using Google drive to save our Models and Dataset. Google drive downloadId expires after some days. Thats why we faced lots of problem in this demo version. We will release a proper version after some months, where we will overcome these issues. Also Lots of new models, features, dataset will be avaiable in that release.  I will recommand you not to use it now. you can use our static project [bn_nlp](https://github.com/Foysal87/bn_nlp) 
